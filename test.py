...
def load_network(net, dataset_mode, crop_size):
    if dataset_mode == 'vip':
        save_path = os.path.join('/home/louming/data/all_data/pretrained/unicorn/model_weights/vip/latest_vip_pixel-wise_256_sota.pth')
    elif dataset_mode == 'landscape' and crop_size == 256:
        save_path = os.path.join('/home/louming/data/all_data/pretrained/unicorn/model_weights/landscape-256/latest_landscape_pixel-wise_256_sota.pth')
    elif dataset_mode == 'landscape' and crop_size == 512:
        save_path = os.path.join('/home/louming/data/all_data/pretrained/unicorn/model_weights/landscape-512/latest_landscape_pixel-wise_512_sota.pth')
    elif dataset_mode == 'traffic' and crop_size == 256:
        save_path = os.path.join('/home/louming/data/all_data/pretrained/unicorn/model_weights/traffic-256/latest_traffic_pixel-wise_256_sota.pth') #todo
    elif dataset_mode == 'traffic' and crop_size == 512:
        save_path = os.path.join('/home/louming/data/all_data/pretrained/unicorn/model_weights/traffic-512/latest_traffic_pixel-wise_512_sota.pth') #todo
